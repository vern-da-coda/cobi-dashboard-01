    ...
    return function e(i, t, n) {
        function r(s, a)
        {
            if (!t[s])
            {
                ...
                var l = t[s] = {exports: {}};
                i[s][0].call(l.exports, function (e) {
                    var t = i[s][1][e];
                    return r(t || e);
                }, l, l.exports, e, i, t, n);
            }
              ...
              function (e, i, t) {
                  ...
                  i.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function (e) {
                              ...
                              !this._events.error || s(this._events.error) && !this._events.error.length))
                      {
                          ...
                          var l = new Error('Uncaught, unspecified "error" event. (' + i + ')');
                          throw l.context = i, l;
                      }
                      ...
                      {
                          for (o = Array.prototype.slice.call(arguments, 1), d = t.slice(), n = d.length, c = 0; c < n; c++)
                          {
                              d[c].apply(this, o);
                          }
                      }
                ...
                var n = e('events'),
                    r = {
                        ...
                        hub:               {
                            motorInterfaceReady:        {
                                read:           function (e, i) {
                                    void 0 !== e && window.COBI.__emitter.once('hub/motorInterfaceReady', e), void 0 !== i && window.COBI.__reporter.once('hub/motorInterfaceReady', i), window.COBI.__read('hub/motorInterfaceReady');
                                }, subscribe:   function (e) {
                                ...
                                read:           function (e, i) {
                                    void 0 !== e && window.COBI.__emitter.once('hub/ambientLightState', e), void 0 !== i && window.COBI.__reporter.once('hub/ambientLightState', i), window.COBI.__read('hub/ambientLightState');
                                }, subscribe:   function (e) {
                        ...
                        battery:           {
                            state: {
                                read:           function (e, i) {
                                    void 0 !== e && window.COBI.__emitter.once('battery/state', e), void 0 !== i && window.COBI.__reporter.once('battery/state', i), window.COBI.__read('battery/state');
                                }, subscribe:   function (e) {
